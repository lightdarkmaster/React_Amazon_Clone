    ...
    <div className="home">
      <div className="home__container">
        <div className="image__container">
          <img className="home__image" src={images[currentImage]} alt="home" />
        </div>
        ...
        <div className="home__row">
          <Product9 title='Oral-B CrossAction All In One Toothbrush, Soft, Deep Plaque Removal, 4 count'
          price={299.00}
          ...
          <Product9 title='Amazon Basics Easy Grip Workout Dumbbell, Neoprene Coated, Various Sets and Weights available'
          price={8999.00}
          image="https://m.media-amazon.com/images/I/81Y26toqdTL._AC_SY200_.jpg"
          rating={4} />

          <Product9 title='Watch Ultra 2 GPS + Cellular 49mm Titanium Case with Blue/Black Trail Loop - M/L with AppleCare+ (2 Years)'
          price={48987}
          image="https://m.media-amazon.com/images/I/71yKLO4EBbL._AC_UY327_FMwebp_QL65_.jpg"
          rating={5} />

          <Product9 title='Galaxy S23 Ultra 5G SM-S918B/DS 256GB 12GB RAM, 200 MP Camera, NGP Wireless Charger Included – Green'
          price={89987}
