  ...
  return (
    ...
    <Link to="/">
      ...
      <div className="login__container">
        <h2> Sign in</h2>
        <br/>
        <span className="login__span"><label><strong>Email or mobile phone number</strong></label></span>
        ...
        <br/>
        <br/>
        <span className="login__span"><p>By continuing, you agree to Amazon's Conditions of Use and Privacy Notice.</p></span>
        <br/>
        <br/>
        <span className="login__span">Need help?</span>
        <hr/>
        <span><strong>Buying for work?</strong></span>
        <br/>
        <span className="login__span">Shop on Amazon Business</span>
      </div>
      <div className="amazon__questions">
